 ...
 *   <li>{@link university.impl.StaffMemberImpl#getRegisteredVehicles <em>Registered Vehicles</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StaffMemberImpl extends NamedElementImpl implements StaffMember {
	/**
	...
	/**
	 * The cached value of the '{@link #getRegisteredVehicles() <em>Registered Vehicles</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getRegisteredVehicles()
	 * @generated
	 * @ordered
	 */
	protected EList<Vehicle> registeredVehicles;
	 ...
	 * @generated
	 */
	public EList<Vehicle> getRegisteredVehicles() {
		if (registeredVehicles == null) {
			registeredVehicles = new EObjectResolvingEList<Vehicle>(Vehicle.class, this, UniversityPackage.STAFF_MEMBER__REGISTERED_VEHICLES);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case UniversityPackage.STAFF_MEMBER__REGISTERED_VEHICLES:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case UniversityPackage.STAFF_MEMBER__TAUGHT_MODULES:
				...
				return;
			case UniversityPackage.STAFF_MEMBER__REGISTERED_VEHICLES:
				getRegisteredVehicles().clear();
				getRegisteredVehicles().addAll((Collection<? extends Vehicle>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case UniversityPackage.STAFF_MEMBER__REGISTERED_VEHICLES:
				return registeredVehicles != null && !registeredVehicles.isEmpty();
		}
