...
public class LibraryPackageImpl extends EPackageImpl implements LibraryPackage {
	 ...
	 * @generated
	 */
	public EAttribute getEmployee_EmployeeType() {
	...
	public void createPackageContents() {
		...
		createEAttribute(employeeEClass, EMPLOYEE__EMPLOYEE_TYPE);
	...
	public void initializePackageContents() {
		...
		initEReference(getAuthor_Books(), this.getBook(), this.getBook_Author(), "books", null, 1, -1, Author.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(employeeEClass, Employee.class, "Employee", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEmployee_EmployeeType(), this.getEmployeeType(), "employeeType", null, 0, 1, Employee.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(employeeTypeEEnum, EmployeeType.TEMP);
		addEEnumLiteral(employeeTypeEEnum, EmployeeType.PERMANANENT);
		addEEnumLiteral(employeeTypeEEnum, EmployeeType.CONTRACT);
