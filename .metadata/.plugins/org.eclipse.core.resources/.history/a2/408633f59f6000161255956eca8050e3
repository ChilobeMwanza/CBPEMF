...
public class LibraryFactoryImpl extends EFactoryImpl implements LibraryFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case LibraryPackage.STUDENT: return createStudent();
			case LibraryPackage.MODULE: return createModule();
			case LibraryPackage.AUTHOR: return createAuthor();
			case LibraryPackage.VEHICLE: return createVehicle();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case LibraryPackage.LIBRARY_TYPE:
