...
public class CBPBinarySerializer 
{
    ...
    private void handleSetEAttributeEvent(SetEAttributeEvent e, OutputStream out) throws IOException
    {
    	...
    	case PersistenceManager.SIMPLE_TYPE_INT:
    		handlePrimitiveEAttributes(e,out, PersistenceManager.SIMPLE_TYPE_INT);
    		break;
    	case PersistenceManager.SIMPLE_TYPE_SHORT:
    		handlePrimitiveEAttributes(e,out, PersistenceManager.SIMPLE_TYPE_SHORT);
    		break;
    	case PersistenceManager.SIMPLE_TYPE_LONG:
    		handlePrimitiveEAttributes(e,out,PersistenceManager.SIMPLE_TYPE_LONG);
    		break;
    	case PersistenceManager.SIMPLE_TYPE_FLOAT:
    		handlePrimitiveEAttributes(e,out, PersistenceManager.SIMPLE_TYPE_FLOAT);
    		break;
    	case PersistenceManager.SIMPLE_TYPE_DOUBLE:
    		handlePrimitiveEAttributes(e,out, PersistenceManager.SIMPLE_TYPE_DOUBLE);
    		break;
    	case PersistenceManager.SIMPLE_TYPE_BOOLEAN:
    		handlePrimitiveEAttributes(e,out, PersistenceManager.SIMPLE_TYPE_BOOLEAN);
    		break;
    	case PersistenceManager.SIMPLE_TYPE_CHAR:
    		handlePrimitiveEAttributes(e,out, PersistenceManager.SIMPLE_TYPE_CHAR);
    		break;
    ...
    private void handlePrimitiveEAttributes(SetEAttributeEvent e,OutputStream out, int primitiveType ) throws IOException
    {
        ...
        if(nullCounter > 0) // for obj with null values, serialise as complex types
        {
        	...
        	handleComplexEAttributes(out,focus_obj,attr,nullList);
        }
    }
    
    private void handleComplexEAttributes(OutputStream out,EObject focus_obj,EAttribute attr, List<Object> attr_values) throws IOException
    {
    ...
    {
    	handleComplexEAttributes(out,e.getFocusObj(),e.getEAttribute(),e.getAttributeValuesList());
    }
