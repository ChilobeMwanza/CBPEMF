...
public class UniversityFactoryImpl extends EFactoryImpl implements UniversityFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case UniversityPackage.STAFF_MEMBER_TYPE:
				return createStaffMemberTypeFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case UniversityPackage.STAFF_MEMBER_TYPE:
				return convertStaffMemberTypeToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public StaffMemberType createStaffMemberTypeFromString(EDataType eDataType, String initialValue) {
		StaffMemberType result = StaffMemberType.get(initialValue);
	 ...
	 * @generated
	 */
	public String convertStaffMemberTypeToString(EDataType eDataType, Object instanceValue) {
