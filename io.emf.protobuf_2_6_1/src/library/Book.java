...
public interface Book extends NamedElement {
	 ...
	 * @see #setIdNumber(double)
	 * @see library.LibraryPackage#getBook_IdNumber()
	 * @model
	 * @generated
	 */
	double getIdNumber();
	...
	/**
	 * Sets the value of the '{@link library.Book#getIdNumber <em>Id Number</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
