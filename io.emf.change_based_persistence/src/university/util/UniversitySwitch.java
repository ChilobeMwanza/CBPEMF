	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UniversityPackage.UNIVERSITY: {
				...
				if (result == null) result = caseNamedElement(university);
			...
			case UniversityPackage.LIBRARY: {
			...
			case UniversityPackage.COMPUTER: {
			...
			case UniversityPackage.STAFF_MEMBER: {
				StaffMember staffMember = (StaffMember)theEObject;
				T result = caseStaffMember(staffMember);
				if (result == null) result = caseNamedElement(staffMember);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UniversityPackage.VEHICLE: {
				Vehicle vehicle = (Vehicle)theEObject;
				T result = caseVehicle(vehicle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UniversityPackage.DEPARTMENT: {
			...
			case UniversityPackage.NAMED_ELEMENT: {
