...
public class DepartmentImpl extends NamedElementImpl implements Department {
	...
	protected EClass eStaticClass() {
		return UniversityPackage.Literals.DEPARTMENT;
	}
	...
	public EList<StaffMember> getStaff() {
		if (staff == null) {
			staff = new EObjectContainmentEList<StaffMember>(StaffMember.class, this, UniversityPackage.DEPARTMENT__STAFF);
		}
		return staff;
	}
	...
	public EList<Student> getStudents() {
		if (students == null) {
			students = new EObjectContainmentEList<Student>(Student.class, this, UniversityPackage.DEPARTMENT__STUDENTS);
		}
		return students;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UniversityPackage.DEPARTMENT__STAFF:
